          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              <Link to="/championship">
                <button className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#1B4F3F" height="20px" width="20px" version="1.1" id="Capa_1" viewBox="0 0 296.084 296.084" xmlSpace="preserve">
                  <g>
